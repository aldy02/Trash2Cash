      ...
      {menuOpen && (
        <div className='w-screen bg-white absolute top-0 right-0 duration-300 transform translate-y-0 group-focus:translate-y-full flex flex-col space-y-3 justify-end'>
          ...
          <Link to='/' onClick={closeMenu}>
            <li className='flex justify-center font-medium text-[#455A64] hover:text-black w-full py-4 hover:bg-green-100'>Homepage</li>
          </Link>
          <Link to='/pickup' onClick={closeMenu}>
            <li className='flex justify-center font-medium text-[#455A64] hover:text-black w-full py-4 hover:bg-green-100'>Pickup</li>
          </Link>
          <Link to='/product' onClick={closeMenu}>
            <li className='flex justify-center font-medium text-[#455A64] hover:text-black w-full py-4 hover:bg-green-100'>Product</li>
          </Link>
        </div>
      )}
    </div>
