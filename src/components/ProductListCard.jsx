        ...
        <div className='animation4 card-container bg-gray-50 hover:bg-gray-100 px-6 py-7 shadow-md rounded-md'>
            <div className="flex">
                ...
                <div className="flex flex-col justify-center">
                    <h2 className="font-bold text-[#263238] text-xl lg:text-[26px]">{title}</h2>
            ...
            <div className="flex justify-center items-center mt-6 mx-auto">
                <Link to={`/admin/product/${id}`} className="w-full mr-6">
                    <button className="text-[#7B7B7B] font-medium lg:font-semibold text-sm lg:text-base hover:border-black hover:text-black border-2 border-[#7B7B7B] py-2 rounded-lg w-full">Change Product</button>
                </Link>
                <button className="text-[#7B7B7B] font-medium lg:font-semibold text-sm lg:text-base hover:border-black hover:text-black border-2 border-[#7B7B7B] py-2 rounded-lg w-full">Delete Product</button>
            </div>
        </div>
    );
};
